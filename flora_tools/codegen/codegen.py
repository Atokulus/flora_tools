...
class CodeGen:
    ...
    def generate_lwb_round_constants(self):
        ...
        lwb_round_constants = {
            ...
            'LWB_STREAM_DEACTIVATION_BACKOFF': lwb_stream.LWB_STREAM_DEACTIVATION_BACKOFF,
            'LWB_STREAM_MAX_BACKOFF_RANGE': lwb_stream.LWB_STREAM_MAX_BACKOFF_RANGE,
            'LWB_STREAM_INITIAL_BACKOFF_RANGE': lwb_stream.LWB_STREAM_INITIAL_BACKOFF_RANGE,
